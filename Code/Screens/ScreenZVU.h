...
void UpdateRegime(void) {
	if (sZVU.count == 0) {
		...
		else if(B118[0].Mem.State.Crash || B118[0].Mem.State.Protect || B118[0].ErrorConnection) {
		...
		else if(B118[1].Mem.State.Crash || B118[1].Mem.State.Protect || B118[1].ErrorConnection) {
			sZVU.selectedCondition[0].SetText("А");
		}
